        ...
        <div className="min-h-screen flex items-center justify-center bg-[var(--color-light-bg)] dark:bg-[var(--color-dark-bg)] p-4">
            ...
            >
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 font-medium">Login to your account</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                    ...
                    >
                        {loading ? <Loader2 className="animate-spin text-white dark:text-black" /> : 'Login'}
                    </button>
                </form>
